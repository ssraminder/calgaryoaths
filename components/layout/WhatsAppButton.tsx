  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-teal flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
      >
        {/* WhatsApp SVG icon */}
        <svg
          width="28"
