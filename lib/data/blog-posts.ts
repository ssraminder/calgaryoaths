...
export const blogPosts: BlogPost[] = [
  ...
  {
    title: 'Certified translation for IQAS — what you need (2025)',
    slug: 'certified-translation-iqas-guide',
    excerpt: 'Planning to get your credentials evaluated by IQAS? Here is what you need to know about certified translations — requirements, languages, and how to get it done right.',
  ...
  {
    title: 'TR to PR 2026 — documents you need ready before the portal opens',
    slug: 'tr-to-pr-2026-document-checklist',
    excerpt: 'The TR to PR 2026 portal will fill fast. This checklist covers every document you need prepared — translations, affidavits, police clearances, and more.',
    category: 'Immigration',
    date: '2025-04-10',
    readTime: '8 min read',
    content: 'Full article coming soon.',
  ...
  {
    title: 'Interpretation services in Calgary — courts, immigration & business',
    slug: 'interpretation-services-calgary-guide',
    excerpt: 'Need an interpreter for a court hearing, immigration interview, or medical appointment in Calgary? Here is how professional interpretation works and when you need it.',
    category: 'General',
    date: '2025-04-15',
    readTime: '5 min read',
    content: 'Full article coming soon.',
  ...
  {
    title: 'Proof of life declaration in Calgary — when and why you need one',
    slug: 'proof-of-life-declaration-calgary',
    excerpt: 'Pension authorities and insurance companies often require a proof of life declaration. Learn what it is, who needs it, and how to get one in Calgary.',
    category: 'Declarations',
    date: '2025-04-20',
    readTime: '4 min read',
    content: 'Full article coming soon.',
  ...
  {
    title: 'Personal guarantee notarization — what lenders require',
    slug: 'personal-guarantee-notarization-guide',
    excerpt: 'Signing a personal guarantee for a loan or lease? Understand what lenders expect, why notarization matters, and how to protect yourself.',
    category: 'General',
    date: '2025-04-25',
    readTime: '5 min read',
    content: 'Full article coming soon.',
  ...
  {
    title: 'Power of Attorney for India from Calgary — complete guide (2025)',
    slug: 'power-of-attorney-india-calgary-guide',
    excerpt: 'Need a POA for property transactions, bank accounts, or legal matters in India? This guide covers GPA vs SPA, apostille requirements, and how to get it done in Calgary.',
