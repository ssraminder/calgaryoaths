...
export const metadata: Metadata = {
  ...
  description:
    'Statutory declarations commissioned in Calgary. Common-law, lost documents, insurance claims & more. Drafting available. From $35. Same-day service.',
