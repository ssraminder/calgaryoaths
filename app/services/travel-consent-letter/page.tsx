...
export default function TravelConsentLetterPage() {
  return (
    <ServicePageLayout
      service={service}
      intro="A travel consent letter is a commissioned document confirming that a child has permission from their parent(s) or legal guardian(s) to travel internationally — either with one parent, with other adults, or as part of a school or supervised group. We commission the letter with our official seal. Drafting to CBSA and airline standards is available at an extra charge."
    />
  );
}
