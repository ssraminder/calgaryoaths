...
export const metadata: Metadata = {
  ...
  keywords: [
    'commissioner of oaths calgary',
    'notary public calgary',
    'affidavit calgary',
    'statutory declaration calgary',
    'travel consent letter calgary',
    'invitation letter IRCC calgary',
    'apostille calgary',
    'certified translation calgary',
    'interpretation services calgary',
    'TR to PR document preparation',
    'notarization calgary',
    'mobile commissioner calgary',
    'same-day notary calgary',
    'power of attorney calgary',
    'power of attorney for India calgary',
    'POA for India property calgary',
    'commissioner near me',
    'document commissioning calgary',
  ],
